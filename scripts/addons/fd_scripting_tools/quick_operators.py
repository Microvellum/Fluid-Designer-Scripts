...
class SolveWhitespaceInconsistency(bpy.types.Operator):
    bl_idname = "fd_scripting_tools.correct_whitespaces"
...
class SelectWholeString(bpy.types.Operator):
    bl_idname = "fd_scripting_tools.select_whole_string"
...
class ConvertFileIndentation(bpy.types.Operator):
    bl_idname = "fd_scripting_tools.convert_file_indentation"
...
class OpenTextBlock(bpy.types.Operator):
    bl_idname = "fd_scripting_tools.open_text_block"
...
def right_click_menu_extension(self, context):
    ...
    if text_block:
        ...
        if match:
            ...
            operator = layout.operator("fd_scripting_tools.execute_function")
...
def format_menu_extension(self, context):
    ...
    if text_block:
        layout = self.layout
        layout.operator("fd_scripting_tools.build_script")
        layout.operator("fd_scripting_tools.correct_whitespaces")
        props = layout.operator("fd_scripting_tools.convert_addon_indentation")
