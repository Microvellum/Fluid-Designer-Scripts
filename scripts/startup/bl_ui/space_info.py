...
class INFO_HT_header(Header):
    ...
    def draw(self, context):
        ...
        if context.scene.mv.ui.use_default_blender_interface:
            if context.scene.mv.ui.show_debug_tools:
                layout.prop(context.scene.mv.ui,"show_debug_tools",icon='DISCLOSURE_TRI_DOWN',text="",emboss=False)
                layout.prop(context.scene.mv.ui,"use_default_blender_interface",icon='BLENDER',text="")
                layout.operator("wm.console_toggle", icon='CONSOLE',text="")
                layout.operator("fluidgeneral.start_debug", icon='GAME',text="")
            else:
                layout.prop(context.scene.mv.ui,"show_debug_tools",icon='DISCLOSURE_TRI_RIGHT',text="",emboss=False)
